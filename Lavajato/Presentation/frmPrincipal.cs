...
{
    public partial class frmPrincipal : login
    {
        public frmPrincipal()
        {
            InitializeComponent();
        ...
        private void ediçãoRetiradaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmRetiradaPesquisa frmRetiradaEdicao = new frmRetiradaPesquisa();
            frmRetiradaEdicao.ShowDialog();
        }

        private void ediçãoEntradaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmPesquisaSuprimento frmSuprimentoPesquisa = new frmPesquisaSuprimento();
            frmSuprimentoPesquisa.ShowDialog();
        }
