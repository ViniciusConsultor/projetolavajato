...
namespace HenryCorporation.Lavajato.Presentation
{
    public partial class frmProdutosInternos : Form
    {
        ...
        //public frmProdutosInternos(ProdutoInterno produtosInternos)
        //{
        //    InitializeComponent();
        ...
        private void nomePesquisa_TextChanged(object sender, EventArgs e)
        {
            ...
            grdProdutos.DataSource = produtoInternoBL.ByName(produto);
            OcultaCampo();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.produtoInterno = ProcuraProduto(this.produtoInterno);
            CarregaCampos(this.produtoInterno);
            frmProdutoRetiradoEstoqueInterno frmProdutoRetiradoEstoque = new frmProdutoRetiradoEstoqueInterno(this.produtoInterno);
            frmProdutoRetiradoEstoque.ShowDialog();
        }
    }
}
